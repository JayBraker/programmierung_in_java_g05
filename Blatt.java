...
public class Blatt
{
	...
	/**
	 * The constructor checks the parameter values for validity and saves them in
	 * blatt. The parameter must contain 3 integers, each in the range of 2 to 14.
	...
	/**
	 * Counts the number of occurances of every card in the blatt attribute, saves
	 * the counts in the attribute verteilung, length 13. The index of verteilung +
	 * 2 is mapped to the value of each card.
	 */
	...
	/**
	 * Returns the value of the third card in the deck if it also contains a two of
	 * a kind.
	 * 
	 * @return int the value of the card
	 */
