...
public class BlattVergleich implements Comparator<Blatt>
{
     ...
     * @return int Returns 1 if o1's value is higher, 0 if their values are equal,
    ...
    public int compare(Blatt o1, Blatt o2)
    {
        ...
        {
            return -1;
        } else if ((o1.isZwilling() || o1.isDrilling()) // wenn Spieler 1 ein Drilling oder ein paar hat und Spieler 2 nichts hat,
                                                        // gewinnt Spieler 1
                && !(o2.isZwilling() || o2.isDrilling()))
        {
            return 1;
        } else if (!(o1.isZwilling() || o1.isDrilling()) // wenn Spieler 2 ein Drilling oder Paar hat und Spieler 1 nichts hat, gewinnt
                                                         // Spieler 2
                && (o2.isZwilling() || o2.isDrilling()))
        {
            return 1;
