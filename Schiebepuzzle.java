...
public class Schiebepuzzle
{
	...
	/**
	 * Default constructor initializes feld as an 2-d array of length 4x4. Fills the
	 * array with the perfect solution to ensure any derivation of this field
	 * remains solvable.
	 */
	...
	/**
	 * Checks if there is an empty Space around the given number if not it returns
	 * false
	 * 
	 * @param i
	...
	/**
	 * This method looks which numbers are next to the given position and saves it.
	 * For that, it gives closeFelder the position of the number and the current
	 * feld
	 * 
	...
	/**
	 * this method looks up if the number given is in the array and returns its
	 * position as int[]
	 * 
